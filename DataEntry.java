...
public class DataEntry extends Application {
    ...
    public boolean saveFormData() {
        ...
        formData.setFname(FnameField.getText());
        formData.setLname(LnameField.getText());
