...
public class DataEntryTest {
    ...
    @Test
    void Test_for_confirmNumGenerator(){
    ...
    @Test
    void Test_for_transition(){
        DataEntry dataEntry = new DataEntry();
        try{
            //test the transtion()
            assertTrue(dataEntry.transition() instanceof ApproverGUI);
